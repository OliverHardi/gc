...
// 1. Toggle picker visibility when clicking the smiley face
...
// 2. Listen for when an emoji is clicked
emojiPicker.addEventListener("emoji-click", (event) => {
    ...
    // Put the cursor back in the input field so the user can keep typing
    messageInput.focus(); 
});

// 3. (Optional but recommended) Close the picker if the user clicks outside of it
